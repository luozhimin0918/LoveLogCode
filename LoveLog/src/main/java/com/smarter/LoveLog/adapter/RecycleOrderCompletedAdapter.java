 ...
 */
public class RecycleOrderCompletedAdapter extends RecyclerView.Adapter<RecycleOrderCompletedAdapter.ViewHolder>{
    ...
    public RecycleOrderCompletedAdapter(String[] names, String[] phones) {
        super();
        mName = names;
        mPhoneNum=phones;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View view = View.inflate(viewGroup.getContext(), R.layout.adapter_activity_order_completed_item, null);
        // 创建一个ViewHolder
