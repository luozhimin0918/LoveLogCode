 ...
 */
public class RecycleOrderWaitTakeOverAdapter extends RecyclerView.Adapter<RecycleOrderWaitTakeOverAdapter.ViewHolder>{
    ...
    public RecycleOrderWaitTakeOverAdapter(String[] names, String[] phones) {
        super();
        mName = names;
        mPhoneNum=phones;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        View view = View.inflate(viewGroup.getContext(), R.layout.adapter_activity_order_wait_take_over_item, null);
        // 创建一个ViewHolder
