 ...
 */
public class CommentReceiveFragment extends Fragment implements RecycleOrderAllAdapter.OnCheckDefaultListener {
            ...
            public void onResponse(InvitationDataPinglunActi pinglunActi) {
                ...
                if(status.getSucceed()==1){
                    ...
                    if(loadingTag==-1){
                        ...
                        Log.d("CommentReceiveFragment", "" + promotePostDateList.size() + "1111++++promotePostDateList" );
                        for(int i=0;i<p.size();i++){
                            promotePostDateList.add(p.get(i));
                        }
                        Log.d("CommentReceiveFragment", "" + promotePostDateList.size() + "2222++++promotePostDateList" );
