 ...
 */
public class RecycleRedpacketHaveExpiredAdapter extends RecyclerView.Adapter<RecycleRedpacketHaveExpiredAdapter.ViewHolder>{
    ...
    public RecycleRedpacketHaveExpiredAdapter(List<RedList> redListList) {
        super();
