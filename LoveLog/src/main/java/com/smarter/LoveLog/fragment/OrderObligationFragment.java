...
import com.smarter.LoveLog.adapter.RecycleOrderObligationAdapter;
 ...
 */
public class OrderObligationFragment extends Fragment implements RecycleOrderObligationAdapter.OnCheckDefaultListener {
    ...
    // 创建Adapter，并指定数据集
    RecycleOrderObligationAdapter adapter;
    public void initRecycleViewVertical(){
        ...
        // 创建Adapter，并指定数据集
        adapter = new RecycleOrderObligationAdapter(dataset,dataValue);
