 ...
 */
public class RedpacketUnusedFragment extends Fragment implements RecycleRedpacketUnusedAdapter.OnCheckDefaultListener {
   ...
   RecyclerView recyclerView;
    ...
    // 创建Adapter，并指定数据集
    RecycleRedpacketUnusedAdapter adapter;
    public void initRecycleViewVertical(){
        ...
        // 创建Adapter，并指定数据集
        adapter = new RecycleRedpacketUnusedAdapter(dataset,dataValue);
