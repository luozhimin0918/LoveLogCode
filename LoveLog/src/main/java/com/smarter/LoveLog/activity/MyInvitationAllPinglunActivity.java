 ...
 */
public class MyInvitationAllPinglunActivity extends BaseFragmentActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_activity_invitation_pinglun_all_view);
    ...
    private void setListen() {
        ...
        sildingFinishLayout.setOnSildingFinishListener(new SildingFinishLayout.OnSildingFinishListener() {
            ...
            public void onSildingFinish() {
                MyInvitationAllPinglunActivity.this.finish();
            }
        });
...
//                }, 2000);
    ...
    private void getDataIntent() {
        ...
        if(intent!=null){
            ...
            promotePostsData= new PromotePostsData();
            promotePostsData.setId("22866");
