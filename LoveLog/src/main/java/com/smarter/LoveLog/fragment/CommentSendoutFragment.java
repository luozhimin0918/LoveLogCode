 ...
 */
public class CommentSendoutFragment extends Fragment implements RecycleOrderAllAdapter.OnCheckDefaultListener {
...
//        initRecycleViewVertical();
    ...
    private void initData(SessionData sessionDataOne) {
        String url ="http://mapp.aiderizhi.com/?url=/user/comment";//
        ...
        if(loadingTag==-1){
            ...
            map.put("json", d);
            Log.d("CommentSendoutFragment", d + "》》》》");
        }
        if(loadingTag==2){//第一次加载数据
            ...
            Log.d("CommentSendoutFragment", oneString + "》》》》");
        }
            ...
            public void onResponse(InvitationDataPinglunActi pinglunActi) {
                ...
                if(status.getSucceed()==1){
                    ...
                    if(loadingTag==-1){
                        ...
                        Log.d("CommentSendoutFragment", "" + promotePostDateList.size() + "2222++++promotePostDateList" );
...
//                    Log.d("CommentSendoutFragment", "" + status.getSucceed() + "++++succeed》》》》" + promotePostDateList.get(0).getCat_name());
                } else {
                    // 请求失败
                    progressLinear.setVisibility(View.GONE);
                    mRecyclerView.setVisibility(View.GONE);
                    ...
                    networkInfo.setVisibility(View.VISIBLE);
                    // 请求失败
                    Log.d("CommentSendoutFragment", "" + status.getSucceed() + "++++success=0》》》》" );
            ...
            public void onErrorResponse(VolleyError volleyError) {
                ...
                networkInfo.setVisibility(View.VISIBLE);
                Log.d("CommentSendoutFragment", "errror" + volleyError.toString() + "++++》》》》" );
            }
        });
    ...
    private RecycleReceivePinglunAdapter mAdapter;
...
//                    public void run() {
                loadingTag = -1;
                Log.d("CommentSendoutFragment", "initial    more");
                initData(sessionData);
//                        mRecyclerView.loadMoreComplete();
//                    }
//                }, 2000);
