 ...
 */
public class OrderCompletedFragment extends Fragment implements RecycleOrderCompletedAdapter.OnCheckDefaultListener {
    ...
    // 创建Adapter，并指定数据集
    RecycleOrderCompletedAdapter adapter;
    public void initRecycleViewVertical(){
        ...
        // 创建Adapter，并指定数据集
        adapter = new RecycleOrderCompletedAdapter(dataset,dataValue);
